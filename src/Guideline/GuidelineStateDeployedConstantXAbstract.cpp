...
QPointF GuidelineStateDeployedConstantXAbstract::convertGraphCoordinateToScreenPoint (double valueGraph)
{
...
double GuidelineStateDeployedConstantXAbstract::extractComponentFromGraphPosition (const QPointF &posGraph) const
{
  return posGraph.x ();
}
