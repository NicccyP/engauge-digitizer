...
QPointF GuidelineStateDeployedConstantYAbstract::convertGraphCoordinateToScreenPoint (double valueGraph)
{
...
double GuidelineStateDeployedConstantYAbstract::extractComponentFromGraphPosition (const QPointF &posGraph) const
{
  return posGraph.y ();
}
